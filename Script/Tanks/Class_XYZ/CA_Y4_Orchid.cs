...
namespace CobaltsArmada
{
    ...
    /// </summary>
    public class CA_Y4_Orchid: CA_ArmadaTank
    {
        ...
        {
            [LangCode.English] = "Orchid"
        };

        public override string Texture => "assets/textures/tank_orchid";
        ...
        public override void PostApplyDefaults()
        {
            ...
            AITank.DrawParams.Scaling = Vector3.One* 1.10f;
            ...
            AITank.Parameters.AimOffset = MathHelper.ToRadians(16);
